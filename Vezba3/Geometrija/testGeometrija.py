...
def main():
    x1 = input("Uneti x koordinatu za pocetnu tacku: ")
    y1 = input("Uneti y koordinatu za pocetnu tacku: ")
    x2 = input("Uneti x koordinatu za krajnu tacku: ")
    y2 = input("Uneti y koordinatu za krajnu tacku: ")

    tacka1 = Tacka(x1, y1)
    tacka2 = Tacka(x2, y2)
    duz1 = Duz.duz(tacka1, tacka2)

    x3 = input("Uneti x koordinatu za pocetnu tacku duži: ")
    y3 = input("Uneti y koordinatu za pocetnu tacku duži: ")
    x4 = input("Uneti x koordinatu za krajnu tacku duži: ")
    y4 = input("Uneti y koordinatu za krajnu tacku duži: ")
    ...
    tacka2 = tacka2.pomeraj(x_pomeraj, y_pomeraj)
    duz1 = Duz.duz(tacka1, tacka2)
